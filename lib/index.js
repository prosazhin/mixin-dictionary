...
export default async function build(options) {
  const { platforms, source, output, mediaAliases, keyframesAliases } = getConfig(options);
  const config = { platforms, source, output, mediaAliases, keyframesAliases, __dirname };
